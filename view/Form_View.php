...
class Form_View extends OptionController\Form_Controller {
    ...
    public function create_html_cov() {
        ...
        echo '<a href="options-general.php?page='.$page_url.'&log=here" class="nav-tab">Log</a>';
        echo '<a href="options-general.php?page='.$page_url.
        ...
        if (isset($_GET['unique_form']) && $_GET['unique_form'] !== "") {
            ...
            if ($form_data !== NULL) {
                ...
                $form_categories_parent = array(
                    ...
                    "desc" => "Pick a parent category, if any", // for use in input label
                ...
                $post_type = array(
                    ...
                    "desc" =>
                        "What post type should this feed be allocated to? (Be careful with what you pick here)", // for use in input label
    ...
    private function admin_sidebar() {
        ...
        echo '<p><a href="http://wordpress.org/support/plugin/affiliate-hoover">Please report any bugs or feature requests here</a></p>';
        echo '<p>Once you have done that please email me <a href="http://about.me/andywalpole">here</a> about the new thread</p>';
        echo '<p>It\'s best that all discussion about this plugin is kept in the public arena so that others can learn from any issues</p>';
        echo '<h3 class="hndle">Hire me</h3>';
        echo '<p>I am an experienced Wordpress developer and I\'m available for all jobs, big and small. I also do one-to-one Wordpress tutorials via Skype. Email me through the site linked to above.</p>';
        echo '</div><!-- end inside -->';
